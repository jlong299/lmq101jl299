...
# # End of template
# ----------------------------------------
# If ff_bus1to16 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 193 linux 2016.08.22.16:44:09
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ff_bus1to16"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_151/sim/ff_bus1to16_fifo_151_4q2xupy.v" -work fifo_151
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ff_bus1to16.v"                                                
}
