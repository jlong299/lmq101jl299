...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_151/sim/ff_CL_buf_preAFU_fifo_151_56ipsny.v" -work ff_CL_buf_preAFU_fifo_151
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ff_CL_buf_preAFU.v"                                                                 
fi
