...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_151/sim/fifo_st_data_fifo_151_xtsoi5y.v" -work fifo_151 -cdslib ./cds_libs/fifo_151.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fifo_st_data.v"                                                                                    
fi
