...
# # End of template
# ----------------------------------------
# If bus2st_1TrbPkt_ram is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "bus2st_1TrbPkt_ram"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_151/sim/bus2st_1TrbPkt_ram_ram_2port_151_a364sna.v" -work ram_2port_151
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/bus2st_1TrbPkt_ram.v"                                                               
}
