...
# # End of template
# ----------------------------------------
# If ff_CL_buf_preAFU is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 win32 2016.10.09.14:01:43
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ff_CL_buf_preAFU"
}
...
ensure_lib                           ./libraries/ff_CL_buf_preAFU_fifo_151/
vmap       ff_CL_buf_preAFU_fifo_151 ./libraries/ff_CL_buf_preAFU_fifo_151/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_151/sim/ff_CL_buf_preAFU_fifo_151_56ipsny.v" -work ff_CL_buf_preAFU_fifo_151
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ff_CL_buf_preAFU.v"                                                                 
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L ff_CL_buf_preAFU_fifo_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L ff_CL_buf_preAFU_fifo_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
