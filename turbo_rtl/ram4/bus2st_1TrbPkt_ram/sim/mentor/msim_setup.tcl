...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_151/sim/bus2st_1TrbPkt_ram_ram_2port_151_a364sna.v" -work ram_2port_151
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/bus2st_1TrbPkt_ram.v"                                                               
}
