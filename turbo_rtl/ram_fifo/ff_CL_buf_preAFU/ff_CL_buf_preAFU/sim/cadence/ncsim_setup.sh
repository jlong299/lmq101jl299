...
TOP_LEVEL_NAME="ff_CL_buf_preAFU"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/ff_CL_buf_preAFU_fifo_151/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_151/sim/ff_CL_buf_preAFU_fifo_151_56ipsny.v" -work ff_CL_buf_preAFU_fifo_151 -cdslib ./cds_libs/ff_CL_buf_preAFU_fifo_151.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ff_CL_buf_preAFU.v"                                                                                                                      
fi
