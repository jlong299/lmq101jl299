...
mkdir -p ./libraries/rom_1port_151/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../rom_1port_151/sim/cnst_rom_rom_1port_151_5e6juei.v" -work rom_1port_151 -cdslib ./cds_libs/rom_1port_151.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/cnst_rom.v"                                                                                                        
fi
