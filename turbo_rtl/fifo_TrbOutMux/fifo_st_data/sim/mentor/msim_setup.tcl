...
# # End of template
# ----------------------------------------
# If fifo_st_data is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 193 linux 2016.07.20.15:43:47
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fifo_st_data"
}
...
ensure_lib          ./libraries/fifo_151/
vmap       fifo_151 ./libraries/fifo_151/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_151/sim/fifo_st_data_fifo_151_xtsoi5y.v" -work fifo_151
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fifo_st_data.v"                                                
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L fifo_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L fifo_151 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
